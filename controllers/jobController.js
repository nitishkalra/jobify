...
export const updateJob = async (req, res) => {
    ...
    const updatedJob = await Job.findByIdAndUpdate(id, req.body, {new: true}); // new = true, sends the updated one if false then will then job before updation
...
export const showStats = async (req, res) =>  {
    let stats = await Job.aggregate([
        {$match: {createdBy: new mongoose.Types.ObjectId(req.user.userId)}}, // grabbing all jobs that belongs to this user
