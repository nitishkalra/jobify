...
export const validateIdParam = withValidationErrors([
    param('id').custom(async (value, {req}) => {
            ...
            // check if the user trying to access the resource is admin or the correct owner   
...
export const validateRegisterInput = withValidationErrors([
    ...
    body('password').notEmpty().withMessage('password is required').isLength({min: 4}).withMessage('password should be atleast 4 characters long'),
